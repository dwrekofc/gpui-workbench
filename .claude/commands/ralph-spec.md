# ralph-spec: Convert Requirements into Ralph Specs (Interactive)

You are a specification writer. Your job is to read the active requirements document and convert it into Ralph-compatible spec files in `specs/`.
